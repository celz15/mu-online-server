...
public:
  ...
  void printHp()
  {
    printf ("HP[Curent:%d,Max:%d,Step:%f,Last Check:%d]\n",
	    o_StatCurHp,o_StatMaxHp,o_StatDHp,o_StatTimeHp);
  };
  void printMp()
  {
    printf("MP[Curent:%d,Max:%d,Step:%f,Last Check:%d]\n",
	   o_StatCurMp,o_StatMaxMp,o_StatDMp,o_StatTimeMp);
  };
  void printSt()
  {
    printf("ST[Curent:%d,Max:%d,Step:%f,Last Check:%d]\n",
	   o_StatCurSt,o_StatMaxSt,o_StatDSt,o_StatTimeSt);
  }
...
public:
  ...
  void IMove()
  {
    ...
    SToMoveID *pack=new SToMoveID(getIndex(),getPosNewX(),getPosNewY(),0);
    broadcastPacket(pack);
    delete pack;
  }
  ...
  {
    SChangeDirectionOrStatus * n=new SChangeDirectionOrStatus(getPosHead(),getPosStatus());
    broadcastPacket(n);	
    delete n;
  };
